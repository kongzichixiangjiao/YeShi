...
//        registerNibWithIdentifier(kYYHomeBasicCell)
    ...
    func initTableViewHeaderView() -> UIView {
        ...
        tableHeaderView.data = [["title" : "活动", "icon" : "home_middle_activity"], ["title" : "赛事", "icon" : "home_middle_event"], ["title" : "直播", "icon" : "home_middle_live"], ["title" : "周边", "icon" : "home_middle_surrounding"], ["title" : "文章", "icon" : "home_middle_article"]]
